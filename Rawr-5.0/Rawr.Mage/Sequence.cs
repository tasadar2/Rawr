...
namespace Rawr.Mage.SequenceReconstruction
{
    public class Sequence : IComparer<SequenceItem>
    {
        ...
        public void GroupCombustion()
        {
            ...
            if (list.Count > 0) GroupCooldown(list, Solver.CombustionDuration, SequenceItem.Calculations.CombustionCooldown, false, Calculations.EffectCooldown[(int)StandardEffect.Combustion], VariableType.None, 0.0);
        }
