...
//                    return "The Damage Per Hit on your current Default Melee Attack is too low. You need to Edit the Attack or select a more appropriate boss." + systemic + afterfix;
        ...
        public float StunningTargsAvgUpTime { get { return Stuns.Count > 0 ? AvgUpTime(Stuns) : 0; } }
        // Fearing Targets
        ...
        public float FearingTargsAvgUpTime { get { return Fears.Count > 0 ? AvgUpTime(Fears) : 0; } }
        // Rooting Targets
        ...
        public float RootingTargsAvgUpTime { get { return Roots.Count > 0 ? AvgUpTime(Roots) : 0; } }
        // Silencing Targets
        ...
        public float SilencingTargsAvgUpTime { get { return Silences.Count > 0 ? AvgUpTime(Silences) : 0; } }
        // Disarming Targets
        ...
        public float DisarmingTargsAvgUpTime { get { return Disarms.Count > 0 ? AvgUpTime(Disarms) : 0; } }
        #endregion
        #endregion
