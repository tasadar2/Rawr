...
namespace Rawr.Bosses
{
    ...
    public class Alysrazor : MultiDiffBoss
    {
        public Alysrazor()
        {
            ...
            #endregion
            #region Basics
            Health = new float[] { 38651400f, 115954200f, 65707380f, 197122144f, 0 }; // TODO: double check 25-man normal health pool
            MobType = (int)MOB_TYPES.ELEMENTAL;
    ...
    public class Ragnaros : MultiDiffBoss
    {
        public Ragnaros()
        {
            ...
            Health = new float[] { 50246820f * 0.9f, 150740464f * 0.9f, 74205536f * 1.40f, 246910064f * 1.40f, 0 }; // TODO: Double check Heroic 10-man health
            MobType = (int)MOB_TYPES.ELEMENTAL;
