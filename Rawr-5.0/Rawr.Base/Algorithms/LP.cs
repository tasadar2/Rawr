...
namespace Rawr.Base.Algorithms
{
...
#endif
    {
...
#endif
#if SILVERLIGHT
        public class ArraySet : LU.ArraySet
#else
        public unsafe class ArraySet : LU.ArraySet
#endif
        {
        ...
        {
            if (row == -1) return;
            A.SetElementUnsafe(row, col, value);
        }
        ...
        public LP(int baseRows, int maxCols, ArraySet arraySet, int maxRedecompose = 50)
        {
            Initialize(baseRows, maxCols, arraySet, maxRedecompose);
        }

        public void Initialize(int baseRows, int maxCols, ArraySet arraySet, int maxRedecompose = 50)
        {
...
#if SILVERLIGHT
        public void BeginSafe(double[] pCost, double[] pData, double[] pValue, int[] pRow, int[] pCol)
        {
            this.pCost = pCost;
            A.BeginSafe(pData, pValue, pRow, pCol);
        }
#else
        public void BeginUnsafe(double* pCost, double* pData, double* pValue, int* pRow, int* pCol)
        {
            this.pCost = pCost;
            A.BeginUnsafe(pData, pValue, pRow, pCol);
        }
#endif
