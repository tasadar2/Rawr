...
namespace Rawr.Warlock
{
    public class Spell
    {
        ...
        public string GetToolTip()
        {
            ...
            {
                float dps = numCasts * AvgDamagePerCast / Mommy.BossOpts.BerserkTimer;
        ...
        public virtual float GetNumCasts()
        {
            if (NumCasts == 0)
            {
                float duration = Mommy.BossOpts.BerserkTimer;
        ...
        public float GetAvgTimeUsed()
        {
            ...
            {
                return GetTimeUsed(BaseCastTime, GCDBonus, Mommy.Haste, Mommy.CalcOpts.Latency);
            }
        }
        ...
        {
            return Mommy.BossOpts.BerserkTimer / GetNumCasts();
        }
        ...
        {
            return StatConversion.GetAverageResistance(Mommy.Character.Level, Mommy.BossOpts.Level, 0f, 0f);
        }
    }
    ...
    public class ChaosBolt : Spell
    {
        ...
        public ChaosBolt(CharacterCalculationsWarlock mommy)
            : base(
                ...
                0f, // recastPeriod,
                WARLOCKSPELLBASEVALUES[mommy.Character.Level - 80] * SCALE, // avgDirectDamage
    ...
    public class Corruption : Spell
    {
        ...
        public Corruption(CharacterCalculationsWarlock mommy)
            : base(
                ...
                0f, // cooldown
                18f, // recast period
                WARLOCKSPELLBASEVALUES[mommy.Character.Level - 80] * SCALE, // base damage per tick
        ...
        private float GuessRollingTriggerFrequency()
        {
            ...
            if (GetRotation().Contains("Shadow Bolt"))
            {
                ...
                freq += .5f / GetTimeUsed(ShadowBolt.GetBaseCastTime(Mommy), 0f, Mommy.Haste, Mommy.CalcOpts.Latency);
            }
            ...
            if (GetRotation().Execute == "Drain Soul (Execute)")
            {
                ...
                freq += Mommy.GetExecutePercentage() * Mommy.BossOpts.BerserkTimer / GetTimeUsed(15f, 0f, Mommy.Haste, Mommy.CalcOpts.Latency);
            }
            return freq;
        }
    }
    ...
    public class BaneOfAgony : Spell
    {
        ...
        { 
            ...
            float baseDamage = WARLOCKSPELLBASEVALUES[mommy.Character.Level - 80] * SCALE * 12f;
    ...
    public class BaneOfDoom : Spell
    {
        ...
        public BaneOfDoom(CharacterCalculationsWarlock mommy)
            : base(
                ...
                0f, // cooldown,
                60f, // recastPeriod,
                WARLOCKSPELLBASEVALUES[mommy.Character.Level - 80] * SCALE, // baseTickDamage,
                4f, // numTicks,
    ...
    public class DemonSoul : Spell
    {
        ...
        public override bool IsCastable()
        {
            return Mommy.Character.Level >= 85;
        }
    }
    ...
    public class FelFlame : Spell
    {
        ...
        public override bool IsCastable()
        {
            return Mommy.Character.Level >= 81;
        }
    }
    ...
    public class Haunt : Spell
    {
        ...
        public Haunt(CharacterCalculationsWarlock mommy)
            : base(
                ...
                8f, // cooldown
                0f, // recast period
                WARLOCKSPELLBASEVALUES[mommy.Character.Level - 80] * SCALE, // avg direct damage
    ...
    public class Immolate : Spell
    {
        ...
        public Immolate(CharacterCalculationsWarlock mommy)
            : base(
                ...
                true, // canMiss,
                WARLOCKSPELLBASEVALUES[mommy.Character.Level - 80] * DIRECTSCALE, // avgDirectDamage,
                DIRECTCOEFF, // directCoefficient,
                mommy.Talents.ImprovedImmolate * .1f, // addedDirectMultiplier,
                WARLOCKSPELLBASEVALUES[mommy.Character.Level - 80] * TICKSCALE, // baseTickDamage,
    ...
    public class ShadowBolt : Spell
    {
        ...
        public ShadowBolt(CharacterCalculationsWarlock mommy)
            : base(
                ...
                0f, // cooldown
                0f, // recast period
                WARLOCKSPELLBASEVALUES[mommy.Character.Level - 80] * SCALE, // avg base
                COEFF, // direct coefficient
    ...
    public class SoulFire : Spell
    {
        ...
        public SoulFire(CharacterCalculationsWarlock mommy)
            : base(
                ...
                COEFF, // directCoefficient,
                0f, // addedDirectMultiplier,
                WARLOCKSPELLBASEVALUES[mommy.Character.Level - 80] * SCALE * mommy.Talents.BurningEmbers * .15f / 7f, // baseTickDamage,
                7f, // numTicks,
                COEFF, // tickCoefficient,
                0f, // addedTickMultiplier,
                true, // canTickCrit,
    ...
    public class UnstableAffliction : Spell
    {
        ...
        public UnstableAffliction(CharacterCalculationsWarlock mommy)
            : base(
                ...
                0f, // cooldown
                15f, // recast period
                WARLOCKSPELLBASEVALUES[mommy.Character.Level - 80] * SCALE, // tick damage
