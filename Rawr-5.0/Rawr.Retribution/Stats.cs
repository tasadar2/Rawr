namespace Rawr.Retribution
{
    public class StatsRetri : Stats
    {
        ...
        /// <summary>
        /// Your Judgement ability now also generates 1 Holy Power.
        /// </summary>
        public bool T13_2P { get; set; }
        /// <summary>
        /// While Zealotry is active your abilities deal 18% more damage.
        /// </summary>
        public bool T13_4P { get; set; }
        /// <summary>
        ...
        public void SetSets(Character character)
        {
            ...
            //T13
            character.SetBonusCount.TryGetValue("Battleplate of Radiant Glory", out TCount);
            if (TCount >= 2) { T13_2P = true; }
            if (TCount >= 4) { T13_4P = true; }
        }
        ...
        public void Accumulate(StatsRetri data)
        {
            ...
            T12_2P = data.T13_2P || T13_2P;
            T12_4P = data.T13_4P || T13_4P;
