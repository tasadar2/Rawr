...
namespace Rawr.Retribution
{
    public class PaladinConstants
    {
        ...
        internal const float JOT_JUDGE_COEFF_STACK = .2f;
        #endregion
        ...
        internal const float TWO_H_SPEC = .25f;
        ...
        internal const float INQUIRY_OF_FAITH_INQ = 2f/3f;
        internal const float JUDGEMENTS_OF_THE_PURE = .03f;

        internal const float CRUSADE = .1f;
        internal const float RULE_OF_LAW = .05f;

        internal const float SANCTIFIED_WRATH_CRIT = .02f;
        internal const float SANCTIFIED_WRATH_CD = 20f;
        ...
        #region Items
        internal const float T13_4P_DMG_BONUS = .18f;
        #endregion
    }
}
