...
namespace Rawr.Brewmaster {
    [Rawr.Calculations.RawrModelInfo("Brewmaster", "spell_monk_brewmaster_spec", CharacterClass.Monk)]
    public class CalculationsBrewmaster : CalculationsBase
    {
        ...
        public override List<GemmingTemplate> DefaultGemmingTemplates
        {
            get
            {
                ...
                {
                    retval.AddRange(BrewmasterGemmingTemplateBlock(tier, Austere));
                }
                retval.AddRange(new GemmingTemplate[] {
                // Engineering cogwheel templates (meta and 2 cogs each, no repeats)
                CreateBrewmasterCogwheelTemplate(Austere, cog_fractured, cog_precise),
                CreateBrewmasterCogwheelTemplate(Austere, cog_fractured, cog_quick),
                CreateBrewmasterCogwheelTemplate(Austere, cog_fractured, cog_rigid),
                CreateBrewmasterCogwheelTemplate(Austere, cog_fractured, cog_smooth),
                CreateBrewmasterCogwheelTemplate(Austere, cog_fractured, cog_subtle),
                CreateBrewmasterCogwheelTemplate(Austere, cog_quick, cog_precise),
                CreateBrewmasterCogwheelTemplate(Austere, cog_quick, cog_rigid),
                CreateBrewmasterCogwheelTemplate(Austere, cog_quick, cog_smooth),
                CreateBrewmasterCogwheelTemplate(Austere, cog_quick, cog_subtle),
                CreateBrewmasterCogwheelTemplate(Austere, cog_rigid, cog_precise),
                CreateBrewmasterCogwheelTemplate(Austere, cog_rigid, cog_smooth),
                CreateBrewmasterCogwheelTemplate(Austere, cog_rigid, cog_subtle),
                CreateBrewmasterCogwheelTemplate(Austere, cog_smooth, cog_precise),
                CreateBrewmasterCogwheelTemplate(Austere, cog_smooth, cog_subtle),
                CreateBrewmasterCogwheelTemplate(Austere, cog_precise, cog_subtle),
                });
                return retval;
            }
        }
        private List<GemmingTemplate> BrewmasterGemmingTemplateBlock(int tier, int meta)
        {
            List<GemmingTemplate> retval = new List<GemmingTemplate>();
            retval.AddRange(new GemmingTemplate[]
            {
                #region All Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, delicate, delicate, delicate, delicate, meta), // Straight Agility
                #endregion
                #region Agility Based
                CreateBrewmasterGemmingTemplate(tier, tierNames, delicate, deft, delicate, delicate, meta), // Agility/Haste/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, delicate, deadly, delicate, delicate, meta), // Agility/Crit/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, delicate, adept, delicate, delicate, meta), // Agility/Mastery/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, delicate, deft, glinting, delicate, meta), // Agility/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, delicate, deft, lightning, delicate, meta), // Agility/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, delicate, deft, shifting, delicate, meta), // Agility/Haste/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, delicate, deadly, glinting, delicate, meta), // Agility/Crit/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, delicate, deadly, piercing, delicate, meta), // Agility/Crit/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, delicate, deadly, shifting, delicate, meta), // Agility/Crit/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, delicate, adept, glinting, delicate, meta), // Agility/Mastery/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, delicate, adept, sensei, delicate, meta), // Agility/Mastery/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, delicate, adept, shifting, delicate, meta), // Agility/Mastery/Stamina
                #endregion
                #region Expertise Based
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, wicked, precise, precise, meta), // Expertise/Haste/Expertise
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, wicked, precise, delicate, meta), // Expertise/Haste/Expertise
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, crafty, precise, precise, meta), // Expertise/Crit/Expertise
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, crafty, precise, delicate, meta), // Expertise/Crit/Expertise
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, keen, precise, precise, meta), // Expertise/Mastery/Expertise
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, keen, precise, delicate, meta), // Expertise/Mastery/Expertise
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, wicked, accurate, precise, meta), // Expertise/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, wicked, accurate, delicate, meta), // Expertise/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, wicked, lightning, delicate, meta), // Expertise/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, wicked, guardian, precise, meta), // Expertise/Haste/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, wicked, guardian, delicate, meta), // Expertise/Haste/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, crafty, accurate, precise, meta), // Expertise/Crit/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, crafty, accurate, delicate, meta), // Expertise/Crit/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, crafty, piercing, delicate, meta), // Expertise/Crit/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, crafty, guardian, precise, meta), // Expertise/Crit/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, crafty, guardian, delicate, meta), // Expertise/Crit/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, keen, accurate, precise, meta), // Expertise/Mastery/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, keen, accurate, delicate, meta), // Expertise/Mastery/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, keen, sensei, delicate, meta), // Expertise/Mastery/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, keen, guardian, precise, meta), // Expertise/Mastery/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, precise, keen, guardian, delicate, meta), // Expertise/Mastery/Stamina
                #endregion
                #region Agility/Dodge Based
                CreateBrewmasterGemmingTemplate(tier, tierNames, polished, polished, polished, polished, meta), // Agility/Dodge/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, polished, subtle, polished, polished, meta), // Agility/Haste/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, polished, deft, polished, polished, meta), // Agility/Haste/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, polished, deadly, polished, polished, meta), // Agility/Crit/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, polished, adept, polished, polished, meta), // Agility/Mastery/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, polished, subtle, nimble, polished, meta), // Agility/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, polished, subtle, lightning, polished, meta), // Agility/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, polished, subtle, regal, polished, meta), // Agility/Haste/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, polished, deft, nimble, polished, meta), // Agility/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, polished, deft, regal, polished, meta), // Agility/Haste/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, polished, deadly, nimble, polished, meta), // Agility/Crit/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, polished, deadly, piercing, polished, meta), // Agility/Crit/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, polished, deadly, regal, polished, meta), // Agility/Crit/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, polished, adept, nimble, polished, meta), // Agility/Mastery/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, polished, adept, sensei, polished, meta), // Agility/Mastery/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, polished, adept, regal, polished, meta), // Agility/Mastery/Stamina
                #endregion
                #region Expertise/Dodge Based
                CreateBrewmasterGemmingTemplate(tier, tierNames, resolute, resolute, resolute, resolute, meta), // Agility/Dodge/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, resolute, subtle, resolute, resolute, meta), // Agility/Haste/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, resolute, wicked, resolute, resolute, meta), // Agility/Haste/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, resolute, crafty, resolute, resolute, meta), // Agility/Crit/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, resolute, keen, resolute, resolute, meta), // Agility/Mastery/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, resolute, subtle, nimble, resolute, meta), // Agility/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, resolute, subtle, lightning, resolute, meta), // Agility/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, resolute, subtle, regal, resolute, meta), // Agility/Haste/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, resolute, wicked, nimble, resolute, meta), // Agility/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, resolute, wicked, regal, resolute, meta), // Agility/Haste/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, resolute, crafty, nimble, resolute, meta), // Agility/Crit/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, resolute, crafty, piercing, resolute, meta), // Agility/Crit/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, resolute, crafty, regal, resolute, meta), // Agility/Crit/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, resolute, keen, nimble, resolute, meta), // Agility/Mastery/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, resolute, keen, sensei, resolute, meta), // Agility/Mastery/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, resolute, keen, regal, resolute, meta), // Agility/Mastery/Stamina
                #endregion
                #region Agility/Mastery Based
                CreateBrewmasterGemmingTemplate(tier, tierNames, adept, polished, polished, polished, meta), // Agility/Dodge/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, adept, subtle, polished, polished, meta), // Agility/Haste/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, adept, deft, polished, polished, meta), // Agility/Haste/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, adept, deadly, polished, polished, meta), // Agility/Crit/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, adept, adept, polished, polished, meta), // Agility/Mastery/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, adept, subtle, nimble, polished, meta), // Agility/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, adept, subtle, lightning, polished, meta), // Agility/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, adept, subtle, regal, polished, meta), // Agility/Haste/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, adept, deft, nimble, polished, meta), // Agility/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, adept, deft, regal, polished, meta), // Agility/Haste/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, adept, deadly, nimble, polished, meta), // Agility/Crit/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, adept, deadly, piercing, piercing, meta), // Agility/Crit/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, adept, deadly, regal, polished, meta), // Agility/Crit/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, adept, adept, nimble, polished, meta), // Agility/Mastery/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, adept, adept, sensei, polished, meta), // Agility/Mastery/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, adept, adept, regal, polished, meta), // Agility/Mastery/Stamina
                #endregion
                #region Expertise/Mastery Based
                CreateBrewmasterGemmingTemplate(tier, tierNames, keen, resolute, resolute, resolute, meta), // Expertise/Dodge/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, keen, subtle, resolute, resolute, meta), // Expertise/Haste/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, keen, wicked, resolute, resolute, meta), // Expertise/Haste/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, keen, crafty, resolute, resolute, meta), // AgExpertiseility/Crit/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, keen, keen, resolute, resolute, meta), // Expertise/Mastery/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, keen, subtle, nimble, resolute, meta), // Expertise/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, keen, subtle, lightning, resolute, meta), // Expertise/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, keen, subtle, regal, resolute, meta), // Expertise/Haste/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, keen, wicked, nimble, resolute, meta), // Expertise/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, keen, wicked, regal, resolute, meta), // Expertise/Haste/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, keen, crafty, nimble, resolute, meta), // Expertise/Crit/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, keen, crafty, piercing, resolute, meta), // Expertise/Crit/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, keen, crafty, regal, resolute, meta), // Expertise/Crit/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, keen, keen, nimble, resolute, meta), // Expertise/Mastery/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, keen, keen, sensei, resolute, meta), // Expertise/Mastery/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, keen, keen, regal, resolute, meta), // Expertise/Mastery/Stamina
                #endregion
                #region Stamina Based
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, deft, shifting, shifting, meta), // Agility/Haste/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, deft, solid, shifting, meta), // Agility/Haste/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, deadly, shifting, shifting, meta), // Agility/Crit/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, deadly, solid, shifting, meta), // Agility/Crit/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, adept, shifting, shifting, meta), // Agility/Mastery/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, adept, solid, shifting, meta), // Agility/Mastery/Agility
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, deft, glinting, shifting, meta), // Agility/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, deft, lightning, shifting, meta), // Agility/Haste/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, deft, shifting, shifting, meta), // Agility/Haste/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, deft, solid, shifting, meta), // Agility/Haste/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, deadly, glinting, shifting, meta), // Agility/Crit/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, deadly, piercing, shifting, meta), // Agility/Crit/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, deadly, shifting, shifting, meta), // Agility/Crit/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, deadly, solid, shifting, meta), // Agility/Crit/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, adept, glinting, shifting, meta), // Agility/Mastery/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, adept, sensei, shifting, meta), // Agility/Mastery/Hit
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, adept, shifting, shifting, meta), // Agility/Mastery/Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, shifting, adept, solid, shifting, meta), // Agility/Mastery/Stamina
                #endregion
                #region All Stamina
                CreateBrewmasterGemmingTemplate(tier, tierNames, solid, solid, solid, solid, meta), // Agility/Mastery/Stamina
                #endregion
            });
            return retval;
        }
        ...
        private GemmingTemplate CreateBrewmasterGemmingTemplate(int tier, string[] tierNames, int[] red, int[] yellow, int[] blue, int[] prismatic, int meta)
        {
        ...
        private GemmingTemplate CreateBrewmasterCogwheelTemplate(int meta, int cogwheel1, int cogwheel2)
        {
            return new GemmingTemplate
            {
                Model = "Brewmaster",
        ...
        /// <summary>
        /// Names and colors for the SubPoints that Rawr.Brewmaster uses
        /// </summary>
...
or trinket/enchant related procs",
...
the Threat Scale defined on the Options tab.",
        ...
        public override ICalculationOptionsPanel CalculationOptionsPanel
        {
            get
            {
                ...
                {
                    _calculationOptionsPanel = new CalculationOptionsPanelBrewmaster();
                }
        ...
        /// <summary>
        /// The class that Rawr.Brewmaster is designed for (Monk)
        /// </summary>
        public override CharacterClass TargetClass { get { return CharacterClass.Monk; } }
        /// <summary>
        /// Creates a new ComparisonCalculationBrewmaster instance
        /// </summary>
        /// <returns>A new ComparisonCalculationBrewmaster instance</returns>
        public override ComparisonCalculationBase CreateNewComparisonCalculation() { return new ComparisonCalculationBrewmaster(); }
        /// <summary>
        /// Creates a new CharacterCalculationsBrewmaster instance
        /// </summary>
        /// <returns>A new CharacterCalculationsBrewmaster instance</returns>
        public override CharacterCalculationsBase CreateNewCharacterCalculations() { return new CharacterCalculationsBrewmaster(); }

        /// <summary>
        /// Deserializes the CalculationOptionsBrewmaster object contained in xml
        /// </summary>
        /// <param name="xml">The CalculationOptionsBrewmaster object, serialized as xml</param>
        /// <returns>The deserialized CalculationOptionsBrewmaster object</returns>
        public override ICalculationOptionBase DeserializeDataObject(string xml)
        {
            System.Xml.Serialization.XmlSerializer serializer =
                new System.Xml.Serialization.XmlSerializer(typeof(CalculationOptionsBrewmaster));
            System.IO.StringReader reader = new System.IO.StringReader(xml);
            CalculationOptionsBrewmaster calcOpts = serializer.Deserialize(reader) as CalculationOptionsBrewmaster;
            return calcOpts;
        }
        #endregion
        ...
        public override List<string> GetRelevantGlyphs()
        {
            if (_relevantGlyphs == null)
            {
                ...
                #region Major
                _relevantGlyphs.Add("Glyph of Breath of Fire");
                _relevantGlyphs.Add("Glyph of Clash");
                _relevantGlyphs.Add("Glyph of Crackling Jade Lightning");
                _relevantGlyphs.Add("Glyph of Enduring Healing Sphere");
                _relevantGlyphs.Add("Glyph of Expel Harm");
                _relevantGlyphs.Add("Glyph of Fortifying Brew");
                _relevantGlyphs.Add("Glyph of Guard");
                _relevantGlyphs.Add("Glyph of Leer of the Ox");
                _relevantGlyphs.Add("Glyph of Path of Blossoms");
                _relevantGlyphs.Add("Glyph of Retreat");
                _relevantGlyphs.Add("Glyph of Spinning Crane Kick");
                _relevantGlyphs.Add("Glyph of Stoneskin");
                _relevantGlyphs.Add("Glyph of Touch of Death");
                _relevantGlyphs.Add("Glyph of Transcendence");
                _relevantGlyphs.Add("Glyph of Zen Meditation");
                #endregion
                #region Minor
                _relevantGlyphs.Add("Glyph of Blackout Kick");
                _relevantGlyphs.Add("Glyph of Crackling Tiger Lightning");
                _relevantGlyphs.Add("Glyph of Fighting Pose");
                _relevantGlyphs.Add("Glyph of Honor");
                _relevantGlyphs.Add("Glyph of Jab");
                _relevantGlyphs.Add("Glyph of Spirit Roll");
                _relevantGlyphs.Add("Glyph of Water Roll");
                _relevantGlyphs.Add("Glyph of Zen Flight");
                #endregion
            }
        ...
        #region Items
        /// <summary>
        /// List of itemtypes that are relevant for Brewmaster
        /// </summary>
        ...
        {
            if ((item.Slot == ItemSlot.Ranged && item.Type != ItemType.Idol && item.Type != ItemType.Relic) ||
        ...
        public override bool IsBuffRelevant(Buff buff, Character character)
        {
            ...
            if (!String.IsNullOrEmpty(buff.SetName) && buff.AllowedClasses.Contains(CharacterClass.Monk))
            {
                if (buff.SetName == "Armor of the Red Crane"            // Tier 14
                    )
                    return true;
            }

            // Any "Gladiator's Sanctuary" set bonus that applies to Druids is the Feral set
            if (!String.IsNullOrEmpty(buff.SetName) && buff.AllowedClasses.Contains(CharacterClass.Monk) && buff.SetName.EndsWith("Ironskin"))
                return true;
        ...
        public Stats GetBuffsStats(Character character, CalculationOptionsBrewmaster calcOpts)
        {
        ...
        public override CharacterCalculationsBase GetCharacterCalculations(Character character, Item additionalItem, bool referenceCalculation, bool significantChange, bool needsDisplayCalculations)
        {
            ...
            CharacterCalculationsBrewmaster calc = new CharacterCalculationsBrewmaster();
            if (character == null) { return calc; }
            CalculationOptionsBrewmaster calcOpts = character.CalculationOptions as CalculationOptionsBrewmaster;
            ...
            StatsBrewmaster stats = GetCharacterStats(character, additionalItem) as StatsBrewmaster;
            ...
            //Temporary so that there is value going through
            calc.SurvivabilityPoints = stats.Health;
        ...
        {
            CalculationOptionsBrewmaster calcOpts = character.CalculationOptions as CalculationOptionsBrewmaster ?? new CalculationOptionsBrewmaster();
            ...
            StatsBrewmaster statsTotal = new StatsBrewmaster();
            ...
            #region PvP
            int PvPCount;
            statsTotal.PvP_2_Piece = false;
            statsTotal.PvP_4_Piece = false;
            character.SetBonusCount.TryGetValue("Gladiator's Ironskin", out PvPCount);
            if (PvPCount >= 2)
            {
                statsTotal.PvPPower += 500f;
                statsTotal.PvP_2_Piece = true;
            }
            if (PvPCount >= 4)
            {
                statsTotal.PvPResilience += 1000f;
                statsTotal.PvP_4_Piece = true;
            }
            #endregion
            ...
            int T14Count;
            character.SetBonusCount.TryGetValue("Armor of the Red Crane", out T14Count);
            if (T14Count >= 2)
            {
            ...
            StatsBrewmaster statsTalents = new StatsBrewmaster()
            {
                ...
                PhysicalDamageTakenReductionMultiplier = 0.25f,
            };
