...
namespace Rawr.TankDK {
    public  class CharacterCalculationsTankDK : CharacterCalculationsBase 
    {
        ...
        public override Dictionary<string, string> GetCharacterDisplayCalculationValues() {
            ...
            dict["Death Strike"] = TotalDShealed.ToString("F0") + "*" + DSCount.ToString("F0") + " Death Strikes Healing for " + DSHeal.ToString("F0") + " avg\n" + DSOverHeal.ToString("F0") + " avg Overheal\n" + DSp5.ToString("F2") + " DSp5\n";
