...
namespace Rawr.Healadin
{
    public class Rotation
    {
        ...
        /*    if (Talents.DivineFavor > 0)
            ...
            // Illumnated Healing
            calc.HealedIH = calc.HealedFoL + calc.HealedHL + calc.HealedHS + calc.HealedWoG + calc.HealedLoD + calc.HealedDL + calc.HealedHR;
            ...
            calc.HealedIH *= CalcOpts.IHEff * (Stats.Mastery * 0.015f);                   
            
            // Beacon of Light
            // 4.3 patch note: Beacon of Light is triggered by Word of Glory, Holy Shock, Flash of Light, Divine Light and Light of Dawn at 50% transference and 
            // Holy Light at 100% transference. It does not transfer Holy Radiance, Protector of the Innocent or other sources of healing.
            calc.HealedBoL = bol.HealingDone(calc.HealedFoL + calc.HealedHS + calc.HealedWoG + calc.HealedLoD + calc.HealedDL + 2f * calc.HealedHL);  
            #endregion


            // adding Holy Radiance and LoH after BoL calculation, as they do not count towards BoL heals
            calc.TotalHealed += calc.HealedLoH + calc.HealedIH + calc.HealedBoL; 
