...
namespace Rawr.Enhance
{
    public class CombatStats
    {
        ...
        public float CritHitModifierMH { get { return chanceWhiteCritMH * (2f * (1f + _stats.BonusCritDamageMultiplier)); } }
        public float NormalHitModifierOH { get { return ChanceWhiteHitOH - chanceWhiteCritOH - GlancingRate; } }
        public float CritHitModifierOH { get { return chanceWhiteCritOH * (2f * (1f + _stats.BonusCritDamageMultiplier)); } }
        ...
        public float WFPPM { get { return hitsPerSWF == 0 ? 0f : 60f * hitsPerSWF / 3f; } } // we tripled the hits to get extra attacks, for PPM we need number of WFs not number of hits
        ...
        public CombatStats(Character character, Stats stats, CalculationOptionsEnhance calcOpts, BossOptions bossOpts)
        {
            ...
            whiteCritDepression = StatConversion.NPC_LEVEL_CRIT_MOD[levelDifference];
            yellowCritDepression = StatConversion.NPC_LEVEL_CRIT_MOD[levelDifference];
            UpdateCalcs(true);
            SetManaRegen();
        ...
        public void UpdateCalcs(bool firstPass)
        {
            ...
            // Melee
            float hitBonus = _stats.PhysicalHit + StatConversion.GetPhysicalHitFromRating(_stats.HitRating);
