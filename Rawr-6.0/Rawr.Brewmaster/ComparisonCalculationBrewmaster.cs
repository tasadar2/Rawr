...
{
    /// <summary>
    /// Data container class for the results of a comparison of two CharacterCalculationsBrewmaster objects
    /// </summary>
    public class ComparisonCalculationBrewmaster : ComparisonCalculationBase
    {
