            ...
            get {
                if (_relevantTriggers == null) {
                    _relevantTriggers = new List<Trigger>() {
                        ...
                        Trigger.DamageTaken, Trigger.DamageTakenMagical, Trigger.DamageTakenPhysical, Trigger.DamageTakenPutsMeBelow35PercHealth, Trigger.DamageTakenPutsMeBelow50PercHealth,
...
//            if (stats.BonusAgilityMultiplier != 0) return true;
            ...
            if (stats.PhysicalDamage != 0) return true;
            if (stats.MaxHealthDamageProc != 0) return true;
