...
threat and limited threat scaled by the threat scale.",
        ...
        private void AccumulateCharacterStats(Player player, Item additionalItem)
        {
            ...
            player.Stats.MaxHealthDamageProc = player.Stats.Health * player.Stats.MaxHealthDamageProc;
        }
        ...
        private bool IsSuperRelevant(Stats stats)
        {
            return
                (
                    ...
                    stats.ThreatIncreaseMultiplier + stats.BonusBlockValueMultiplier + stats.HealthRestoreFromMaxHealth
                ) != 0;
        }
        ...
        private bool IsRelevant(Stats stats)
        {
            return
                (stats.Agility + stats.Armor +
                    ...
                    stats.MovementSpeed + stats.FearDurReduc + stats.StunDurReduc + stats.SnareRootDurReduc + stats.MaxHealthDamageProc
                ) != 0;
        }
