...
namespace Rawr.UnitTests.ShadowPriest
{
    ...
    /// </summary>
    [TestClass]
    public class Calculations_GetCharacterStats_Untalented_ItemSet3 : Calculations_GetCharacterStatsBase
    {
        protected override void SetupCharacter(Character character)
        {
            character.Race = CharacterRace.Draenei;
