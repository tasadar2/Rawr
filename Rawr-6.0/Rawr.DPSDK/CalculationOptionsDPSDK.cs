...
namespace Rawr.DPSDK
{
    public class CalculationOptionsDPSDK : ICalculationOptionBase, INotifyPropertyChanged
    {
        ...
        private Presence _presence = Presence.Unholy;
        ...
        {
            get { return _KMConsumeRate; }
            set { _KMConsumeRate = value; OnPropertyChanged("KMConsumeRate"); }
        }
        private float _KMConsumeRate = .9f;
