...
namespace Rawr.Base.Algorithms
{
...
#endif
    {
        ...
        public SparseMatrix(int rows, int maxCols, LP.ArraySet arraySet)
        {
            Initialize(rows, maxCols, arraySet);
        }

        public void Initialize(int rows, int maxCols, LP.ArraySet arraySet)
        {
