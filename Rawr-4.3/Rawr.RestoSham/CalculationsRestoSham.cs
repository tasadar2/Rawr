    ...
    public class CalculationsRestoSham : CalculationsBase
    {
        ...
        public override List<GemmingTemplate> DefaultGemmingTemplates
        {
            get
            {
                ...
                //Red
                int[] Brilliant = { 52084, 52207, 71881, 52257 };  // Int
                //Purple
                int[] Purified = { 52100, 52236, 71868 };  // Int/Spir
                int[] Timeless = { 52098, 52248, 71871 };  //Int/Stam
                //Blue
                int[] Sparkling = { 52087, 52244, 71819, 52262 };  // Spir
                //Green
                int[] Forceful = { 52124, 52218, 71836 };  // Haste/Stam
                int[] Jagged = { 52121, 52223, 71834 };    // Crit/Stam
                int[] Puissant = { 52126, 52231, 71838 };  //Mastery / Stam
                int[] Zen = { 52127, 52250, 71827 };       //Mastery / Spirit
                //Yellow
                int[] Quick = { 52093, 52232, 71876, 52268 };      // Haste
                int[] Smooth = { 52091, 52241, 71874, 52266 };     // Crit
                int[] Fractured = { 52094, 52219, 71877, 52269 };  // Mastery
                //Orange
                int[] Artful = { 52117, 52205, 71854 };   // Int/Mastery
                int[] Reckless = { 52113, 52208, 71850 }; // Haste/Int
                int[] Potent = { 52110, 52239, 71842 };   // Crit/Int
                //Meta
                ...
                return new List<GemmingTemplate>()
                {
                    ...
                    new GemmingTemplate() { Model = "RestoSham", Group = "Rare", RedId = Sparkling[1], YellowId = Sparkling[1], BlueId = Sparkling[1], PrismaticId = Sparkling[1], MetaId = Revitalizing },
                    new GemmingTemplate() { Model = "RestoSham", Group = "Epic", Enabled = true, RedId = Sparkling[2], YellowId = Sparkling[2], BlueId = Sparkling[2], PrismaticId = Sparkling[2], MetaId = Revitalizing },
                    ...
                    new GemmingTemplate() { Model = "RestoSham", Group = "Rare", RedId = Purified[1], YellowId = Zen[1], BlueId = Sparkling[1], PrismaticId = Sparkling[1], MetaId = Revitalizing },
                    new GemmingTemplate() { Model = "RestoSham", Group = "Epic", Enabled = true, RedId = Purified[2], YellowId = Zen[2], BlueId = Sparkling[2], PrismaticId = Sparkling[2], MetaId = Revitalizing },
                    new GemmingTemplate() { Model = "RestoSham", Group = "Jewelcrafter", RedId = Purified[2], YellowId = Zen[2], BlueId = Sparkling[3], PrismaticId = Sparkling[3], MetaId = Revitalizing },
                    #endregion
                    ...
                    new GemmingTemplate() { Model = "RestoSham", Group = "Rare", RedId = Brilliant[1], YellowId = Brilliant[1], BlueId = Brilliant[1], PrismaticId = Brilliant[1], MetaId = Ember },
                    new GemmingTemplate() { Model = "RestoSham", Group = "Epic", Enabled = true, RedId = Brilliant[2], YellowId = Brilliant[2], BlueId = Brilliant[2], PrismaticId = Brilliant[2], MetaId = Ember },
                    ...
                    new GemmingTemplate() { Model = "RestoSham", Group = "Rare", RedId = Brilliant[1], YellowId = Reckless[1], BlueId = Timeless[1], PrismaticId = Brilliant[1], MetaId = Ember },
                    new GemmingTemplate() { Model = "RestoSham", Group = "Epic", Enabled = true, RedId = Brilliant[2], YellowId = Reckless[2], BlueId = Timeless[2], PrismaticId = Brilliant[2], MetaId = Ember },
                    new GemmingTemplate() { Model = "RestoSham", Group = "Jewelcrafter", RedId = Brilliant[3], YellowId = Reckless[2], BlueId = Timeless[2], PrismaticId = Brilliant[3], MetaId = Ember },
                    #endregion
                    ...
                    new GemmingTemplate() { Model = "RestoSham", Group = "Rare", RedId = Fractured[1], YellowId = Fractured[1], BlueId = Fractured[1], PrismaticId = Fractured[1], MetaId = Fleet },
                    new GemmingTemplate() { Model = "RestoSham", Group = "Epic", Enabled = true, RedId = Fractured[2], YellowId = Fractured[2], BlueId = Fractured[2], PrismaticId = Fractured[2], MetaId = Fleet },
                    ...
                    new GemmingTemplate() { Model = "RestoSham", Group = "Rare", RedId = Artful[1], YellowId = Fractured[1], BlueId = Puissant[1], PrismaticId = Fractured[1], MetaId = Fleet },
                    new GemmingTemplate() { Model = "RestoSham", Group = "Epic", Enabled = true, RedId = Artful[2], YellowId = Fractured[2], BlueId = Puissant[2], PrismaticId = Fractured[2], MetaId = Fleet },
                    new GemmingTemplate() { Model = "RestoSham", Group = "Jewelcrafter", RedId = Artful[2], YellowId = Fractured[3], BlueId = Puissant[2], PrismaticId = Fractured[3], MetaId = Fleet },
                    #endregion
                    ...
                    new GemmingTemplate() { Model = "RestoSham", Group = "Rare", RedId = Smooth[1], YellowId = Smooth[1], BlueId = Smooth[1], PrismaticId = Smooth[1], MetaId = Revitalizing },
                    new GemmingTemplate() { Model = "RestoSham", Group = "Epic", Enabled = true, RedId = Smooth[2], YellowId = Smooth[2], BlueId = Smooth[2], PrismaticId = Smooth[2], MetaId = Revitalizing },
                    ...
                    new GemmingTemplate() { Model = "RestoSham", Group = "Rare", RedId = Potent[1], YellowId = Smooth[1], BlueId = Jagged[1], PrismaticId = Smooth[1], MetaId = Revitalizing },
                    new GemmingTemplate() { Model = "RestoSham", Group = "Epic", Enabled = true, RedId = Potent[2], YellowId = Smooth[2], BlueId = Jagged[2], PrismaticId = Smooth[2], MetaId = Revitalizing },
                    new GemmingTemplate() { Model = "RestoSham", Group = "Jewelcrafter", RedId = Potent[2], YellowId = Smooth[3], BlueId = Jagged[2], PrismaticId = Smooth[3], MetaId = Revitalizing },
                    #endregion
                    ...
                    new GemmingTemplate() { Model = "RestoSham", Group = "Rare", RedId = Quick[1], YellowId = Quick[1], BlueId = Quick[1], PrismaticId = Quick[1], MetaId = Ember },
                    new GemmingTemplate() { Model = "RestoSham", Group = "Epic", Enabled = true, RedId = Quick[2], YellowId = Quick[2], BlueId = Quick[2], PrismaticId = Quick[2], MetaId = Ember },
                    ...
                    new GemmingTemplate() { Model = "RestoSham", Group = "Rare", RedId = Reckless[1], YellowId = Quick[1], BlueId = Forceful[1], PrismaticId = Quick[1], MetaId = Ember },
                    new GemmingTemplate() { Model = "RestoSham", Group = "Epic", Enabled = true, RedId = Reckless[2], YellowId = Quick[2], BlueId = Forceful[2], PrismaticId = Quick[2], MetaId = Ember },
                    new GemmingTemplate() { Model = "RestoSham", Group = "Jewelcrafter", RedId = Reckless[2], YellowId = Quick[3], BlueId = Forceful[2], PrismaticId = Quick[3], MetaId = Ember },
                    #endregion
                };
            }
        }
