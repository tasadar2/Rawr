...
namespace Rawr.ProtPaladin
{
    public class CharacterCalculationsProtPaladin : CharacterCalculationsBase
    {
        ...
        public override Dictionary<string, string> GetCharacterDisplayCalculationValues()
        {
            ...
            dictValues.Add("Dodge", string.Format("{0:0.0000%}*Dodge Rating {1}, {2:0.00%} Dodge before DR", Dodge, BasicStats.DodgeRating, 0.05f + StatConversion.GetDodgeFromRating(BasicStats.DodgeRating)));
            dictValues.Add("Parry", string.Format("{0:0.0000%}*Parry Rating {1}, {2:0.00%} Parry before DR", Parry, BasicStats.ParryRating, 0.05f + StatConversion.GetParryFromRating(BasicStats.ParryRating)));
            dictValues.Add("Block", string.Format("{0:0.0000%}*Block Rating {1}, {2:0.00%} Block before DR", Block, BasicStats.BlockRating, 0.05f + Mastery * 0.0225f));
            ...
            dictValues.Add("Avoidance + Block", string.Format("{0:0.0000%}*After DR and target-level reduction", DodgePlusMissPlusParryPlusBlock));
