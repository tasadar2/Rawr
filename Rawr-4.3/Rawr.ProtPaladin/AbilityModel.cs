        ...
        private void CalculateDamage() {
            ...
            switch (Ability) {
                ...
                case Ability.CrusaderStrike:
                    ...
                    baseDamage = Lookup.WeaponDamage(Character, AP, true);
                    baseDamage *= 1.2f
                ...
                case Ability.HammerOfTheRighteous:
                    ...
                    baseDamage = Lookup.WeaponDamage(Character, AP, true) * 0.3f;
                ...
                case Ability.SealOfTruth:
                    {
                        ...
                        baseDamage = Lookup.WeaponDamage(Character, AP, false) * 0.018f * censureStacks;
