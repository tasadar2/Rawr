        ...
        virtual public float TotalDamage
        {
            get 
            {
                ...
                switch (DamageType)
                {
                    ...
                    {
                        dmgTypeModifier += m_Stats.BonusFrostDamageMultiplier + m_Stats.BonusFrostDamageMultiplierFromMastery;
                        break;
                    }
                    ...
                    {
                        dmgTypeModifier += m_Stats.BonusShadowDamageMultiplier + m_Stats.BonusShadowDamageMultiplierFromMastery;
                        break;
                    }
                }
