...
namespace Rawr
{
    ...
    public class Enchant
    {
        ...
        private static List<Enchant> GetDefaultEnchants()
        {
            ...
            #region Level 90 (MoP)
            /*
            defaultEnchants.Add(new Enchant(0, "Accuracy", ItemSlot.Back, new Stats() { HitRating = 180 }, "inv_enchant_formulagood_01"));
            defaultEnchants.Add(new Enchant(0, "Greater Protection", ItemSlot.Back, new Stats() { BonusArmor = 550 }, "spell_holy_greaterheal"));
            defaultEnchants.Add(new Enchant(0, "Superior Intellect", ItemSlot.Back, new Stats() { Intellect = 180 }, "spell_holy_greaterheal"));
            defaultEnchants.Add(new Enchant(0, "Superior Critical Strike", ItemSlot.Back, new Stats() { CritRating = 180 }, "inv_enchant_formulagood_01"));
            */
            #endregion
            #region Level 85 (Cataclysm)
            ...
            #region Level 90 (MoP)
            /*
            defaultEnchants.Add(new Enchant(0, "Super Resilience", ItemSlot.Chest, new Stats() { Resilience = 200 }, "spell_holy_greaterheal"));
            defaultEnchants.Add(new Enchant(0, "Mighty Spirit", ItemSlot.Chest, new Stats() { Spirit = 200 }, "spell_holy_greaterheal"));
            defaultEnchants.Add(new Enchant(0, "Glorious Stats", ItemSlot.Chest, new Stats() { Agility = 80, Strength = 80, Stamina = 80, Intellect = 80, Spirit = 80 }, "inv_enchant_formulagood_01"));
            defaultEnchants.Add(new Enchant(0, "Superior Stamina", ItemSlot.Chest, new Stats() { Stamina = 300 }, "inv_enchant_formulagood_01"));
             */
            #endregion
            #region Level 85 (Cataclysm)
            ...
            #region Level 90 (MoP)
            /*
            defaultEnchants.Add(new Enchant(0, "Mastery", ItemSlot.Wrist, new Stats() { MasteryRating = 170 }, "spell_holy_greaterheal"));
            defaultEnchants.Add(new Enchant(0, "Superior Dodge", ItemSlot.Wrist, new Stats() { DodgeRating = 170 }, "spell_holy_greaterheal"));
            defaultEnchants.Add(new Enchant(0, "Super Intellect", ItemSlot.Wrist, new Stats() { Intellect = 170 }, "spell_holy_greaterheal"));
            defaultEnchants.Add(new Enchant(0, "Exceptional Strength", ItemSlot.Wrist, new Stats() { Strength = 170 }, "spell_holy_greaterheal"));
            defaultEnchants.Add(new Enchant(0, "Greater Agility", ItemSlot.Wrist, new Stats() { Agility = 170 }, "spell_holy_greaterheal"));
            */
            #endregion
            #region Level 85 (Cataclysm)
            ...
            #region Level 90 (MoP)
            /*
            defaultEnchants.Add(new Enchant(0, "Greater Haste", ItemSlot.Hands, new Stats() { HasteRating = 170 }, "spell_holy_greaterheal"));
            defaultEnchants.Add(new Enchant(0, "Superior Expertise", ItemSlot.Hands, new Stats() { ExpertiseRating = 170 }, "spell_holy_greaterheal"));
            defaultEnchants.Add(new Enchant(0, "Super Strength", ItemSlot.Hands, new Stats() { Strength = 170 }, "inv_enchant_formulagood_01"));
            defaultEnchants.Add(new Enchant(0, "Superior Mastery", ItemSlot.Hands, new Stats() { MasteryRating = 170 }, "spell_holy_greaterheal"));
            */
            #endregion
            #region Level 85 (Cataclysm)
            ...
            #region Level 90 (MoP)
            /*
            defaultEnchants.Add(new Enchant(0, "Greater Haste", ItemSlot.Feet, new Stats() { HasteRating = 175 }, "spell_holy_greaterheal"));
            defaultEnchants.Add(new Enchant(0, "Greater Precision", ItemSlot.Feet, new Stats() { HitRating = 175 }, "spell_holy_greaterheal"));
            defaultEnchants.Add(new Enchant(0, "Blurred Speed", ItemSlot.Feet, new Stats() { Agility = 140, MovementSpeed = 0.08f }, "inv_enchant_formulagood_01"));
            defaultEnchants.Add(new Enchant(0, "Pandaren's Step", ItemSlot.Feet, new Stats() { MasteryRating = 140, MovementSpeed = 0.08f }, "inv_enchant_formulagood_01"));
            */
            #endregion
            #region Level 85 (Cataclysm)
            ...
            /*
            {
                // http://www.wowdb.com/items/79061-enchant-weapon-pandamonium
                // Proc spell - http://www.wowdb.com/spells/110761-pandamonium
                enchantTemp = new Stats() { };
                enchantTemp.AddSpecialEffect(new SpecialEffect(Trigger.MeleeHit, new Stats() { AttackPower = 1000, }, 12, 0, -1f));
                defaultEnchants.Add(new Enchant(0, "Pandamonium", ItemSlot.OneHand, enchantTemp, "pandarenracial_innerpeace"));
            }
            {
                // http://www.wowdb.com/items/74723-enchant-weapon-windsong
                // Haste - http://www.wowdb.com/spells/104423-windsong
                // Crit - http://www.wowdb.com/spells/104509-windsong
                // Mastery - http://www.wowdb.com/spells/104510-windsong
                enchantTemp = new Stats() { };
                enchantTemp.AddSpecialEffect(new SpecialEffect(Trigger.MeleeHit, new Stats() { HighestSecondaryStat = 1500, }, 12, 0, -1f));
                enchantTemp.AddSpecialEffect(new SpecialEffect(Trigger.DamageSpellHit, new Stats() { HighestSecondaryStat = 1500, }, 12, 0, -1f));
                defaultEnchants.Add(new Enchant(0, "Windsong", ItemSlot.OneHand, enchantTemp, "spell_frost_arcticwinds"));
            }
            {
                // http://www.wowdb.com/items/74724-enchant-weapon-jade-spirit
                // Proc spell - http://www.wowdb.com/spells/104993-jade-spirit
                enchantTemp = new Stats() { };
                enchantTemp.AddSpecialEffect(new SpecialEffect(Trigger.SpellCast, new Stats() { Intellect = 1650, JadeSpiritProcSpirit = 750 }, 12, 0, -1f));
                defaultEnchants.Add(new Enchant(0, "Jade Spirit", ItemSlot.OneHand, enchantTemp, "spell_shaman_spiritlink"));
            }
            {
                // http://www.wowdb.com/items/74725-enchant-weapon-elemental-force
                // Proc spell - http://www.wowdb.com/spells/116616-elemental-force
                enchantTemp = new Stats() { };
                enchantTemp.AddSpecialEffect(new SpecialEffect(Trigger.MeleeHit, new Stats() { FireDamage = 3000, }, 0, 0, -1f));
                enchantTemp.AddSpecialEffect(new SpecialEffect(Trigger.DamageSpellHit, new Stats() { FireDamage = 3000, }, 0, 0, -1f));
                defaultEnchants.Add(new Enchant(0, "Elemental Force", ItemSlot.OneHand, enchantTemp, "ability_mage_firestarter"));
            }
            {
                // http://www.wowdb.com/items/74726-enchant-weapon-dancing-steel
                // Strength - http://www.wowdb.com/spells/118335-dancing-steel
                // Agility - http://www.wowdb.com/spells/118334-dancing-steel
                enchantTemp = new Stats() { };
                enchantTemp.AddSpecialEffect(new SpecialEffect(Trigger.MeleeHit, new Stats() { HighestStat = 1650, }, 12, 0, -1f));
                defaultEnchants.Add(new Enchant(0, "Dancing Steel", ItemSlot.OneHand, enchantTemp, "trade_archaeology_zinrokh-sword"));
            }
            {
                // http://www.wowdb.com/items/74727-enchant-weapon-colossus
                // Proc spell - http://www.wowdb.com/spells/116631-colossus
                enchantTemp = new Stats() { };
                enchantTemp.AddSpecialEffect(new SpecialEffect(Trigger.MeleeHit, new Stats() { DamageAbsorbed = 8000, }, 10, 30, 1f));
                defaultEnchants.Add(new Enchant(0, "Colossus", ItemSlot.OneHand, enchantTemp, "ability_vehicle_shellshieldgenerator"));
            }
            {
                // http://www.wowdb.com/items/74728-enchant-weapon-flowing-river
                // Proc spell - http://www.wowdb.com/spells/116660-flowing-river
                enchantTemp = new Stats() { };
                enchantTemp.AddSpecialEffect(new SpecialEffect(Trigger.MeleeHit, new Stats() { Dodge = 1650, }, 12, 0, -1f));
                defaultEnchants.Add(new Enchant(0, "Flowing River", ItemSlot.OneHand, enchantTemp, "inv_misc_volatilewater"));
            }
            */
            #endregion
            #region Level 85 (Cataclysm)
            ...
            #region Level 90 (MoP)
            /*
            defaultEnchants.Add(new Enchant(0, "Major Intellect", ItemSlot.OffHand, new Stats() { Intellect = 165 }, "spell_holy_greaterheal"));
             */
            #endregion
            #region Level 85 (Cataclysm)
