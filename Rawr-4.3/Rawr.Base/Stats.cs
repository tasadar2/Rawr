...
namespace Rawr
{
...
#endif
    {
        ...
        [DefaultValueAttribute(0f)]
        [DisplayName("Jade Spirit Proc when below 25% mana")]
        [Category("Equipment Effects")]
        public float JadeSpiritProcSpirit
        {
            get { return _rawAdditiveData[(int)AdditiveStat.JadeSpiritProcSpirit]; }
            set { _rawAdditiveData[(int)AdditiveStat.JadeSpiritProcSpirit] = value; }
        }
        #endregion
        #region ===== Health Related Stats =====
        [DefaultValueAttribute(0f)]
        ...
        {
            get { return _rawAdditiveData[(int)AdditiveStat.Mastery]; }
            set { _rawAdditiveData[(int)AdditiveStat.Mastery] = value; }
        }
        [DefaultValueAttribute(0f)]
        [Category("Misc")]
