...
namespace Rawr.Hunter.Skills
{
    ...
    public class ExplosiveShotLNL : ExplosiveShot
    {
        public ExplosiveShotLNL(Character c, StatsHunter s, CombatFactors cf, WhiteAttacks wa, CalculationOptionsHunter co)
        {
            Char = c; StatS = s; combatFactors = cf; Whiteattacks = wa; CalcOpts = co;
