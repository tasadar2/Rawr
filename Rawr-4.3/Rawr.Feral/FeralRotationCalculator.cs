...
{
	public class FeralRotationCalculator
	{
		private FeralAbilityBuilder Abilities { get; set; }
		...
		public FeralRotationCalculator(FeralAbilityBuilder abilities, int fightDuration, MangleUsage mangleUsage)
		{
			Abilities = abilities;
        ...
        public FeralRotationCalculation GetOptimalRotation()
		{
            FeralRotationCalculation highestDPSRotation = new FeralRotationCalculation();
        ...
        public FeralRotationCalculation CalculateRotation(int roarCP, BiteUsage biteUsage)
		{
			float totalEnergy =
            ...
            return new FeralRotationCalculation()
			{
    ...
    public class FeralRotationCalculation
	{
		...
		public override string ToString()
		{
			...
			rotation.AppendFormat("{0:N0}dps {1}Roar {2}FB*Priorities:\r\n", DPS, RoarCP, 
				BiteUsage == Feral.BiteUsage.None ? "No" :
				(BiteUsage == Feral.BiteUsage.HighEnergy ? "Hi" : "Low"));
			...
			if (BiteUsage != Feral.BiteUsage.None) rotation.AppendFormat("Use {0}energy, 5cp Ferocious Bites to spend extra combo points.\r\n", BiteUsage == Feral.BiteUsage.HighEnergy ? "70" : "35");
